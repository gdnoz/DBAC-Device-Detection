"""
Taken and slightly modified from https://github.com/metachris/pdfminer/blob/master/tools/pdf2txt.py
under MIT license.
...
def main(args=None):
    ...
    P.add_argument("-p", "--pagenos", type=str,
                   help="Comma-separated list of page numbers to parse. Included for legacy applications, use -P/--page-numbers for more idiomatic argument entry.")
