...
def run_application() -> str:
    ...
    return SimulateAndQueryDeviceApplication.run_application(objectIdentifier=20, objectName="SRI70_001", objectType=8, systemStatus='operational', vendorName='SyxthSense Ltd',
                                                             vendorIdentifier=651, modelName='SRI7', protocolVersion=1, protocolRevision=10, maxapdulength=480, segmentationSupported="noSegmentation",
