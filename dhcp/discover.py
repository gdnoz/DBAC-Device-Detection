...
if __name__ == "__main__":
    DHCPSpoofing.send_dhcp_discover("/Users/mathiasthomsen/Dropbox/Uni/0_DBAC Thesis/DBAC Device Detection/data/mudfiles/Chromecast Ultra.json","00:A0:C9:14:C8",[1,33,3,6,15,28,51,58,59],"dhcpcd-5.2.10:Linux-3.8.13+:armv7l:Marvell Berlin SoC (Flattened Device Tree)")