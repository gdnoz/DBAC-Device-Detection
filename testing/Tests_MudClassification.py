...
def synthetic_test_set_test(threshold: float):
    '''
    ...
    print("****************** TEST COMPLETE: c_tresh: " + str(threshold)+ " ******************")
...
def synthetic_test_set_test_with_s_thresh(threshold: float, s_threshold: float):
    '''
    Tests the classification of MUD files using the set of test mud files specified in data/mud_synthetic_test_set.csv
    :param threshold: threshold to be used for the mud classification.
    :return:
    ...
    mud_classifier = MudClassification(threshold,s_threshold)
